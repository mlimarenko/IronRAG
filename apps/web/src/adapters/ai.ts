...
export function mapCredential(
  raw: RawProviderCredentialResponse,
...
export function mapProviderList(raw: RawProviderCatalogEntry[] | null | undefined): AIProvider[] {
  return normalizeArray(raw).map(mapProvider);
}

export function mapModelList(raw: RawModelCatalogEntry[] | null | undefined): AIModelOption[] {
  return normalizeArray(raw).map(mapModelOption);
}

export function mapCredentialList(
  raw: RawProviderCredentialResponse[] | null | undefined,
  providers: AIProvider[],
): AICredential[] {
...
export function mapPresetList(
  raw: RawModelPresetResponse[] | null | undefined,
  providers: AIProvider[],
  models: AIModelOption[],
): ModelPreset[] {
...
export function mapBindingList(
  raw: RawBindingAssignmentResponse[] | null | undefined,
): AIBindingAssignment[] {
