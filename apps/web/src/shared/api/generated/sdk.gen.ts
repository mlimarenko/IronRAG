...
import type { BatchCancelContentDocumentsData, BatchCancelContentDocumentsErrors, BatchCancelContentDocumentsResponses, BatchDeleteContentDocumentsData, BatchDeleteContentDocumentsErrors, BatchDeleteContentDocumentsResponses, BatchReprocessContentDocumentsData, BatchReprocessContentDocumentsErrors, BatchReprocessContentDocumentsResponses, BulkIngestQueueActionData, BulkIngestQueueActionErrors, BulkIngestQueueActionResponses, CancelContentWebIngestRunData, CancelContentWebIngestRunErrors, CancelContentWebIngestRunResponses, CancelIngestQueueJobData, CancelIngestQueueJobErrors, CancelIngestQueueJobResponses, CreateAiAccountData, CreateAiAccountErrors, CreateAiAccountResponses, CreateAiBindingValidationData, CreateAiBindingValidationErrors, CreateAiBindingValidationResponses, CreateAiLibraryBindingData, CreateAiLibraryBindingErrors, CreateAiLibraryBindingResponses, CreateAiModelData, CreateAiModelErrors, CreateAiModelResponses, CreateAiPriceOverrideData, CreateAiPriceOverrideErrors, CreateAiPriceOverrideResponses, CreateAiProviderData, CreateAiProviderErrors, CreateAiProviderResponses, CreateCatalogLibraryData, CreateCatalogLibraryErrors, CreateCatalogLibraryResponses, CreateCatalogWorkspaceData, CreateCatalogWorkspaceErrors, CreateCatalogWorkspaceResponses, CreateContentDocumentData, CreateContentDocumentErrors, CreateContentDocumentResponses, CreateContentRevisionData, CreateContentRevisionErrors, CreateContentRevisionResponses, CreateContentWebIngestRunData, CreateContentWebIngestRunErrors, CreateContentWebIngestRunResponses, CreateIamUserData, CreateIamUserErrors, CreateIamUserResponses, CreateQuerySessionData, CreateQuerySessionErrors, CreateQuerySessionResponses, CreateQuerySessionTurnData, CreateQuerySessionTurnErrors, CreateQuerySessionTurnResponses, CreateWebhookSubscriptionData, CreateWebhookSubscriptionErrors, CreateWebhookSubscriptionResponses, DeleteAiAccountData, DeleteAiAccountErrors, DeleteAiAccountResponses, DeleteAiLibraryBindingData, DeleteAiLibraryBindingErrors, DeleteAiLibraryBindingResponses, DeleteAiModelData, DeleteAiModelErrors, DeleteAiModelResponses, DeleteAiPriceOverrideData, DeleteAiPriceOverrideErrors, DeleteAiPriceOverrideResponses, DeleteAiProviderData, DeleteAiProviderErrors, DeleteAiProviderResponses, DeleteCatalogLibraryData, DeleteCatalogLibraryErrors, DeleteCatalogLibraryResponses, DeleteCatalogWorkspaceData, DeleteCatalogWorkspaceErrors, DeleteCatalogWorkspaceResponses, DeleteContentDocumentData, DeleteContentDocumentErrors, DeleteContentDocumentResponses, DeleteIamTokenData, DeleteIamTokenErrors, DeleteIamTokenResponses, DeleteIamUserData, DeleteIamUserErrors, DeleteIamUserResponses, DeleteQuerySessionData, DeleteQuerySessionErrors, DeleteQuerySessionResponses, DeleteWebhookSubscriptionData, DeleteWebhookSubscriptionErrors, DeleteWebhookSubscriptionResponses, ExportCatalogWorkspaceSnapshotData, ExportCatalogWorkspaceSnapshotErrors, ExportCatalogWorkspaceSnapshotResponses, ExportLibrarySnapshotData, ExportLibrarySnapshotErrors, ExportLibrarySnapshotResponses, GetAdminSurfaceData, GetAdminSurfaceErrors, GetAdminSurfaceResponses, GetAiAccountData, GetAiAccountErrors, GetAiAccountResponses, GetAiBindingValidationData, GetAiBindingValidationErrors, GetAiBindingValidationResponses, GetAiLibraryBindingData, GetAiLibraryBindingErrors, GetAiLibraryBindingResponses, GetAiModelData, GetAiModelErrors, GetAiModelResponses, GetAiPriceOverrideData, GetAiPriceOverrideErrors, GetAiPriceOverrideResponses, GetAiProviderData, GetAiProviderErrors, GetAiProviderResponses, GetAssistantSystemPromptData, GetAssistantSystemPromptErrors, GetAssistantSystemPromptResponses, GetAsyncOperationData, GetAsyncOperationErrors, GetAsyncOperationResponses, GetBillingExecutionCostData, GetBillingExecutionCostErrors, GetBillingExecutionCostResponses, GetBootstrapStatusData, GetBootstrapStatusResponses, GetCatalogLibraryData, GetCatalogLibraryErrors, GetCatalogLibraryResponses, GetCatalogLibraryRetrievalConfigData, GetCatalogLibraryRetrievalConfigErrors, GetCatalogLibraryRetrievalConfigResponses, GetCatalogWorkspaceData, GetCatalogWorkspaceErrors, GetCatalogWorkspaceResponses, GetContentDocumentData, GetContentDocumentErrors, GetContentDocumentHeadData, GetContentDocumentHeadErrors, GetContentDocumentHeadResponses, GetContentDocumentResponses, GetContentDocumentSourceData, GetContentDocumentSourceErrors, GetContentDocumentSourceResponses, GetContentWebIngestRunData, GetContentWebIngestRunErrors, GetContentWebIngestRunResponses, GetHealthData, GetHealthResponses, GetIamMeData, GetIamMeErrors, GetIamMeResponses, GetIamSessionData, GetIamSessionErrors, GetIamSessionResponses, GetIamTokenData, GetIamTokenErrors, GetIamTokenResponses, GetIamUserAccessData, GetIamUserAccessErrors, GetIamUserAccessResponses, GetIngestAttemptData, GetIngestAttemptErrors, GetIngestAttemptResponses, GetIngestJobData, GetIngestJobErrors, GetIngestJobResponses, GetKnowledgeContextBundleData, GetKnowledgeContextBundleErrors, GetKnowledgeContextBundleResponses, GetKnowledgeEntityData, GetKnowledgeEntityErrors, GetKnowledgeEntityResponses, GetKnowledgeGraphWorkbenchData, GetKnowledgeGraphWorkbenchErrors, GetKnowledgeGraphWorkbenchResponses, GetKnowledgeLibrarySummaryData, GetKnowledgeLibrarySummaryErrors, GetKnowledgeLibrarySummaryResponses, GetKnowledgeRelationData, GetKnowledgeRelationErrors, GetKnowledgeRelationResponses, GetLibraryCostSummaryData, GetLibraryCostSummaryErrors, GetLibraryCostSummaryResponses, GetLibraryDashboardData, GetLibraryDashboardErrors, GetLibraryDashboardResponses, GetLibraryStateData, GetLibraryStateErrors, GetLibraryStateResponses, GetMcpCapabilitiesData, GetMcpCapabilitiesErrors, GetMcpCapabilitiesResponses, GetMcpDiagnosticsCapabilitiesData, GetMcpDiagnosticsCapabilitiesErrors, GetMcpDiagnosticsCapabilitiesResponses, GetOpenApiContractData, GetOpenApiContractResponses, GetQueryExecutionData, GetQueryExecutionErrors, GetQueryExecutionLlmContextData, GetQueryExecutionLlmContextErrors, GetQueryExecutionLlmContextResponses, GetQueryExecutionResponses, GetQuerySessionData, GetQuerySessionErrors, GetQuerySessionResponses, GetQuerySessionTurnData, GetQuerySessionTurnErrors, GetQuerySessionTurnResponses, GetReadinessData, GetReadinessErrors, GetReadinessResponses, GetReleaseUpdateData, GetReleaseUpdateResponses, GetRuntimeExecutionData, GetRuntimeExecutionErrors, GetRuntimeExecutionResponses, GetRuntimeExecutionTraceData, GetRuntimeExecutionTraceErrors, GetRuntimeExecutionTraceResponses, GetVersionData, GetVersionResponses, GetWebhookSubscriptionData, GetWebhookSubscriptionErrors, GetWebhookSubscriptionResponses, GetWorkspaceCostSummaryData, GetWorkspaceCostSummaryErrors, GetWorkspaceCostSummaryResponses, ImportCatalogWorkspaceSnapshotData, ImportCatalogWorkspaceSnapshotErrors, ImportCatalogWorkspaceSnapshotResponses, ImportLibrarySnapshotData, ImportLibrarySnapshotErrors, ImportLibrarySnapshotResponses, ListAiAccountsData, ListAiAccountsErrors, ListAiAccountsResponses, ListAiBindingValidationsData, ListAiBindingValidationsErrors, ListAiBindingValidationsResponses, ListAiLibraryBindingsData, ListAiLibraryBindingsErrors, ListAiLibraryBindingsResponses, ListAiModelsData, ListAiModelsErrors, ListAiModelsResponses, ListAiPricesData, ListAiPricesErrors, ListAiPricesResponses, ListAiProvidersData, ListAiProvidersErrors, ListAiProvidersResponses, ListAuditEventsData, ListAuditEventsErrors, ListAuditEventsResponses, ListBillingChargesData, ListBillingChargesErrors, ListBillingChargesResponses, ListBillingLibraryDocumentCostsData, ListBillingLibraryDocumentCostsErrors, ListBillingLibraryDocumentCostsResponses, ListBillingProviderCallsData, ListBillingProviderCallsErrors, ListBillingProviderCallsResponses, ListCatalogLibrariesData, ListCatalogLibrariesErrors, ListCatalogLibrariesResponses, ListCatalogWorkspacesData, ListCatalogWorkspacesErrors, ListCatalogWorkspacesResponses, ListChunksData, ListChunksErrors, ListChunksResponses, ListContentDocumentsData, ListContentDocumentsErrors, ListContentDocumentsResponses, ListContentPreparedSegmentsData, ListContentPreparedSegmentsErrors, ListContentPreparedSegmentsResponses, ListContentRevisionsData, ListContentRevisionsErrors, ListContentRevisionsResponses, ListContentTechnicalFactsData, ListContentTechnicalFactsErrors, ListContentTechnicalFactsResponses, ListContentWebIngestRunPagesData, ListContentWebIngestRunPagesErrors, ListContentWebIngestRunPagesResponses, ListContentWebIngestRunsData, ListContentWebIngestRunsErrors, ListContentWebIngestRunsResponses, ListIamTokensData, ListIamTokensErrors, ListIamTokensResponses, ListIamUsersData, ListIamUsersErrors, ListIamUsersResponses, ListIngestJobAttemptsData, ListIngestJobAttemptsErrors, ListIngestJobAttemptsResponses, ListIngestJobsData, ListIngestJobsErrors, ListIngestJobsResponses, ListIngestQueueData, ListIngestQueueErrors, ListIngestQueueResponses, ListIngestStageEventsData, ListIngestStageEventsErrors, ListIngestStageEventsResponses, ListKnowledgeContextBundlesData, ListKnowledgeContextBundlesErrors, ListKnowledgeContextBundlesResponses, ListKnowledgeLibraryGenerationsData, ListKnowledgeLibraryGenerationsErrors, ListKnowledgeLibraryGenerationsResponses, ListKnowledgeRelationsData, ListKnowledgeRelationsErrors, ListKnowledgeRelationsResponses, ListQuerySessionsData, ListQuerySessionsErrors, ListQuerySessionsResponses, ListQuerySessionTurnsData, ListQuerySessionTurnsErrors, ListQuerySessionTurnsResponses, ListWebhookDeliveryAttemptsData, ListWebhookDeliveryAttemptsErrors, ListWebhookDeliveryAttemptsResponses, ListWebhookSubscriptionsData, ListWebhookSubscriptionsErrors, ListWebhookSubscriptionsResponses, LoginIamSessionData, LoginIamSessionErrors, LoginIamSessionResponses, LogoutIamSessionData, LogoutIamSessionErrors, LogoutIamSessionResponses, MintIamTokenData, MintIamTokenErrors, MintIamTokenResponses, MoveIngestQueueJobData, MoveIngestQueueJobErrors, MoveIngestQueueJobResponses, PatchContentDocumentMetadataData, PatchContentDocumentMetadataErrors, PatchContentDocumentMetadataResponses, PatchIamTokenData, PatchIamTokenErrors, PatchIamTokenResponses, PauseIngestQueueJobData, PauseIngestQueueJobErrors, PauseIngestQueueJobResponses, PostBootstrapSetupData, PostBootstrapSetupErrors, PostBootstrapSetupResponses, PostMcpDiagnosticsRequestData, PostMcpDiagnosticsRequestErrors, PostMcpDiagnosticsRequestResponses, PostMcpRequestData, PostMcpRequestErrors, PostMcpRequestResponses, RenameQuerySessionData, RenameQuerySessionErrors, RenameQuerySessionResponses, ReprocessContentDocumentData, ReprocessContentDocumentErrors, ReprocessContentDocumentResponses, ResolveIamSessionData, ResolveIamSessionResponses, ResumeIngestQueueJobData, ResumeIngestQueueJobErrors, ResumeIngestQueueJobResponses, RetryIngestQueueJobData, RetryIngestQueueJobErrors, RetryIngestQueueJobResponses, RevokeIamTokenData, RevokeIamTokenErrors, RevokeIamTokenResponses, SearchKnowledgeLibraryData, SearchKnowledgeLibraryErrors, SearchKnowledgeLibraryResponses, SetIamUserAccessData, SetIamUserAccessErrors, SetIamUserAccessResponses, SetIamUserRoleData, SetIamUserRoleErrors, SetIamUserRoleResponses, UpdateAiAccountData, UpdateAiAccountErrors, UpdateAiAccountResponses, UpdateAiLibraryBindingData, UpdateAiLibraryBindingErrors, UpdateAiLibraryBindingResponses, UpdateAiModelData, UpdateAiModelErrors, UpdateAiModelResponses, UpdateAiPriceOverrideData, UpdateAiPriceOverrideErrors, UpdateAiPriceOverrideResponses, UpdateAiProviderData, UpdateAiProviderErrors, UpdateAiProviderResponses, UpdateCatalogLibraryData, UpdateCatalogLibraryErrors, UpdateCatalogLibraryRecognitionPolicyData, UpdateCatalogLibraryRecognitionPolicyErrors, UpdateCatalogLibraryRecognitionPolicyResponses, UpdateCatalogLibraryResponses, UpdateCatalogLibraryRetrievalConfigData, UpdateCatalogLibraryRetrievalConfigErrors, UpdateCatalogLibraryRetrievalConfigResponses, UpdateCatalogLibraryWebIngestPolicyData, UpdateCatalogLibraryWebIngestPolicyErrors, UpdateCatalogLibraryWebIngestPolicyResponses, UpdateCatalogWorkspaceData, UpdateCatalogWorkspaceErrors, UpdateCatalogWorkspaceResponses, UpdateWebhookSubscriptionData, UpdateWebhookSubscriptionErrors, UpdateWebhookSubscriptionResponses } from './types.gen';
...
export class Ai {
     ...
     */
    public static getAiAccount<ThrowOnError extends boolean = false>(options: Options<GetAiAccountData, ThrowOnError>): RequestResult<GetAiAccountResponses, GetAiAccountErrors, ThrowOnError> {
        return (options.client ?? client).get<GetAiAccountResponses, GetAiAccountErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/ai/accounts/{accountId}',
            ...options
        });
    ...
    public static updateAiAccount<ThrowOnError extends boolean = false>(options: Options<UpdateAiAccountData, ThrowOnError>): RequestResult<UpdateAiAccountResponses, UpdateAiAccountErrors, ThrowOnError> {
        return (options.client ?? client).patch<UpdateAiAccountResponses, UpdateAiAccountErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/ai/accounts/{accountId}',
            ...options,
            headers: {
     ...
     */
    public static getAiLibraryBinding<ThrowOnError extends boolean = false>(options: Options<GetAiLibraryBindingData, ThrowOnError>): RequestResult<GetAiLibraryBindingResponses, GetAiLibraryBindingErrors, ThrowOnError> {
        return (options.client ?? client).get<GetAiLibraryBindingResponses, GetAiLibraryBindingErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/ai/bindings/{bindingId}',
            ...options
        });
    ...
    public static updateAiLibraryBinding<ThrowOnError extends boolean = false>(options: Options<UpdateAiLibraryBindingData, ThrowOnError>): RequestResult<UpdateAiLibraryBindingResponses, UpdateAiLibraryBindingErrors, ThrowOnError> {
        return (options.client ?? client).patch<UpdateAiLibraryBindingResponses, UpdateAiLibraryBindingErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/ai/bindings/{bindingId}',
            ...options,
            headers: {
     ...
     * Manages library-level AI runtime bindings. A binding assigns an account and model to a purpose (embedding, query answering, graph extraction, and other AI purposes) for one library, with tuning parameters (system prompt, temperature, top-p, output token budget) stored inline. Call it for paginated or filtered table views. Prefer server-side filters and cursors over fetching broad result sets into the client.
     */
    public static listAiBindingValidations<ThrowOnError extends boolean = false>(options: Options<ListAiBindingValidationsData, ThrowOnError>): RequestResult<ListAiBindingValidationsResponses, ListAiBindingValidationsErrors, ThrowOnError> {
        return (options.client ?? client).get<ListAiBindingValidationsResponses, ListAiBindingValidationsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Manages library-level AI runtime bindings. A binding assigns an account and model to a purpose (embedding, query answering, graph extraction, and other AI purposes) for one library, with tuning parameters (system prompt, temperature, top-p, output token budget) stored inline. Call it to create work or submit a command. Some commands complete synchronously, while ingest, mutation, and runtime work can continue asynchronously.
     */
    public static createAiBindingValidation<ThrowOnError extends boolean = false>(options: Options<CreateAiBindingValidationData, ThrowOnError>): RequestResult<CreateAiBindingValidationResponses, CreateAiBindingValidationErrors, ThrowOnError> {
        return (options.client ?? client).post<CreateAiBindingValidationResponses, CreateAiBindingValidationErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/ai/bindings/{bindingId}/validations',
            ...options
        });
     ...
     * Manages library-level AI runtime bindings. A binding assigns an account and model to a purpose (embedding, query answering, graph extraction, and other AI purposes) for one library, with tuning parameters (system prompt, temperature, top-p, output token budget) stored inline. Call it when the caller already has the resource identifier and needs the latest authorized server view.
     */
    public static getAiBindingValidation<ThrowOnError extends boolean = false>(options: Options<GetAiBindingValidationData, ThrowOnError>): RequestResult<GetAiBindingValidationResponses, GetAiBindingValidationErrors, ThrowOnError> {
        return (options.client ?? client).get<GetAiBindingValidationResponses, GetAiBindingValidationErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static getAiModel<ThrowOnError extends boolean = false>(options: Options<GetAiModelData, ThrowOnError>): RequestResult<GetAiModelResponses, GetAiModelErrors, ThrowOnError> {
        return (options.client ?? client).get<GetAiModelResponses, GetAiModelErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/ai/models/{modelId}',
            ...options
        });
    ...
    public static updateAiModel<ThrowOnError extends boolean = false>(options: Options<UpdateAiModelData, ThrowOnError>): RequestResult<UpdateAiModelResponses, UpdateAiModelErrors, ThrowOnError> {
        return (options.client ?? client).patch<UpdateAiModelResponses, UpdateAiModelErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/ai/models/{modelId}',
            ...options,
            headers: {
     ...
     */
    public static getAiPriceOverride<ThrowOnError extends boolean = false>(options: Options<GetAiPriceOverrideData, ThrowOnError>): RequestResult<GetAiPriceOverrideResponses, GetAiPriceOverrideErrors, ThrowOnError> {
        return (options.client ?? client).get<GetAiPriceOverrideResponses, GetAiPriceOverrideErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/ai/price-overrides/{overrideId}',
            ...options
        });
    ...
    public static updateAiPriceOverride<ThrowOnError extends boolean = false>(options: Options<UpdateAiPriceOverrideData, ThrowOnError>): RequestResult<UpdateAiPriceOverrideResponses, UpdateAiPriceOverrideErrors, ThrowOnError> {
        return (options.client ?? client).patch<UpdateAiPriceOverrideResponses, UpdateAiPriceOverrideErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/ai/price-overrides/{overrideId}',
            ...options,
            headers: {
     ...
     * Reads the AI provider catalog used by the admin configuration screens. Operators use this metadata to choose providers, models, capabilities, and binding targets. Call it when the caller already has the resource identifier and needs the latest authorized server view.
     */
    public static getAiProvider<ThrowOnError extends boolean = false>(options: Options<GetAiProviderData, ThrowOnError>): RequestResult<GetAiProviderResponses, GetAiProviderErrors, ThrowOnError> {
        return (options.client ?? client).get<GetAiProviderResponses, GetAiProviderErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/ai/providers/{providerId}',
            ...options
        });
...
export class Catalog {
     ...
     */
    public static updateCatalogWorkspace<ThrowOnError extends boolean = false>(options: Options<UpdateCatalogWorkspaceData, ThrowOnError>): RequestResult<UpdateCatalogWorkspaceResponses, UpdateCatalogWorkspaceErrors, ThrowOnError> {
        return (options.client ?? client).patch<UpdateCatalogWorkspaceResponses, UpdateCatalogWorkspaceErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/catalog/workspaces/{workspaceId}',
            ...options,
            headers: {
     ...
     */
    public static exportCatalogWorkspaceSnapshot<ThrowOnError extends boolean = false>(options: Options<ExportCatalogWorkspaceSnapshotData, ThrowOnError>): RequestResult<ExportCatalogWorkspaceSnapshotResponses, ExportCatalogWorkspaceSnapshotErrors, ThrowOnError> {
        return (options.client ?? client).get<ExportCatalogWorkspaceSnapshotResponses, ExportCatalogWorkspaceSnapshotErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Manages catalog workspaces. Workspaces group libraries, IAM scope, billing summaries, and administrative ownership boundaries. Call it to replace or partially update server-owned configuration. The request body is validated before changes are persisted.
     */
    public static importCatalogWorkspaceSnapshot<ThrowOnError extends boolean = false>(options: Options<ImportCatalogWorkspaceSnapshotData, ThrowOnError>): RequestResult<ImportCatalogWorkspaceSnapshotResponses, ImportCatalogWorkspaceSnapshotErrors, ThrowOnError> {
        return (options.client ?? client).put<ImportCatalogWorkspaceSnapshotResponses, ImportCatalogWorkspaceSnapshotErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/catalog/workspaces/{workspaceId}/snapshot',
            ...options,
            headers: {
...
export class Content {
     ...
     */
    public static createContentRevision<ThrowOnError extends boolean = false>(options: Options<CreateContentRevisionData, ThrowOnError>): RequestResult<CreateContentRevisionResponses, CreateContentRevisionErrors, ThrowOnError> {
        return (options.client ?? client).post<CreateContentRevisionResponses, CreateContentRevisionErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/content/documents/{documentId}/revisions',
            ...options,
            headers: {
...
export class Iam {
     ...
     */
    public static getIamToken<ThrowOnError extends boolean = false>(options: Options<GetIamTokenData, ThrowOnError>): RequestResult<GetIamTokenResponses, GetIamTokenErrors, ThrowOnError> {
        return (options.client ?? client).get<GetIamTokenResponses, GetIamTokenErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/iam/tokens/{tokenId}',
            ...options
        });
     ...
     */
    public static patchIamToken<ThrowOnError extends boolean = false>(options: Options<PatchIamTokenData, ThrowOnError>): RequestResult<PatchIamTokenResponses, PatchIamTokenErrors, ThrowOnError> {
        return (options.client ?? client).patch<PatchIamTokenResponses, PatchIamTokenErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/iam/tokens/{tokenId}',
            ...options,
            headers: {
     ...
     */
    public static deleteIamUser<ThrowOnError extends boolean = false>(options: Options<DeleteIamUserData, ThrowOnError>): RequestResult<DeleteIamUserResponses, DeleteIamUserErrors, ThrowOnError> {
        return (options.client ?? client).delete<DeleteIamUserResponses, DeleteIamUserErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class Ingest {
     ...
     * Reads or controls ingest runtime state. Operators use these endpoints to inspect queued work, attempts, stage events, and document-processing failures. Call it for paginated or filtered table views. Prefer server-side filters and cursors over fetching broad result sets into the client.
     */
    public static listIngestJobAttempts<ThrowOnError extends boolean = false>(options: Options<ListIngestJobAttemptsData, ThrowOnError>): RequestResult<ListIngestJobAttemptsResponses, ListIngestJobAttemptsErrors, ThrowOnError> {
        return (options.client ?? client).get<ListIngestJobAttemptsResponses, ListIngestJobAttemptsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class Knowledge {
     ...
     * Reads the knowledge model derived from ingested documents. These endpoints power graph workbench views, document memory search, context-bundle inspection, and entity/relation drill-downs. Call it for paginated or filtered table views. Prefer server-side filters and cursors over fetching broad result sets into the client.
     */
    public static listKnowledgeRelations<ThrowOnError extends boolean = false>(options: Options<ListKnowledgeRelationsData, ThrowOnError>): RequestResult<ListKnowledgeRelationsResponses, ListKnowledgeRelationsErrors, ThrowOnError> {
        return (options.client ?? client).get<ListKnowledgeRelationsResponses, ListKnowledgeRelationsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static searchKnowledgeLibrary<ThrowOnError extends boolean = false>(options: Options<SearchKnowledgeLibraryData, ThrowOnError>): RequestResult<SearchKnowledgeLibraryResponses, SearchKnowledgeLibraryErrors, ThrowOnError> {
        return (options.client ?? client).post<SearchKnowledgeLibraryResponses, SearchKnowledgeLibraryErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class Query {
     ...
     */
    public static deleteQuerySession<ThrowOnError extends boolean = false>(options: Options<DeleteQuerySessionData, ThrowOnError>): RequestResult<DeleteQuerySessionResponses, DeleteQuerySessionErrors, ThrowOnError> {
        return (options.client ?? client).delete<DeleteQuerySessionResponses, DeleteQuerySessionErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static renameQuerySession<ThrowOnError extends boolean = false>(options: Options<RenameQuerySessionData, ThrowOnError>): RequestResult<RenameQuerySessionResponses, RenameQuerySessionErrors, ThrowOnError> {
        return (options.client ?? client).patch<RenameQuerySessionResponses, RenameQuerySessionErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v1/query/sessions/{sessionId}',
            ...options,
            headers: {
     ...
     */
    public static listQuerySessionTurns<ThrowOnError extends boolean = false>(options: Options<ListQuerySessionTurnsData, ThrowOnError>): RequestResult<ListQuerySessionTurnsResponses, ListQuerySessionTurnsErrors, ThrowOnError> {
        return (options.client ?? client).get<ListQuerySessionTurnsResponses, ListQuerySessionTurnsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static getQuerySessionTurn<ThrowOnError extends boolean = false>(options: Options<GetQuerySessionTurnData, ThrowOnError>): RequestResult<GetQuerySessionTurnResponses, GetQuerySessionTurnErrors, ThrowOnError> {
        return (options.client ?? client).get<GetQuerySessionTurnResponses, GetQuerySessionTurnErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
