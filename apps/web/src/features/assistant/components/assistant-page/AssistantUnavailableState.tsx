...
import { AlertTriangle, FileText, MessageSquare, type LucideIcon } from 'lucide-react'
...
function EmptyState({
  ...
  return (
    <PageShell header={<PageHeader title={t('assistant.title')} />} bodyClassName="empty-state">
      <WorkbenchEmptyState
        icon={
          <Icon
