  ...
  const label = isTerminal
    ? hasFailures
      ? bulkRerun.kind === "delete"
        ? t("documents.bulkDeleteDoneWithFailures", {
      ...
      : bulkRerun.kind === "delete"
        ? t("documents.bulkDeleteDone", { total: bulkRerun.total })
        : t("documents.bulkRerunDone", { total: bulkRerun.total })
    : isFinalizing
      ? bulkRerun.kind === "delete"
        ? t("documents.bulkDeleteFinalizing", { total: bulkRerun.total })
        : t("documents.bulkRerunFinalizing", { total: bulkRerun.total })
      : bulkRerun.kind === "delete"
        ? t("documents.bulkDeleteInFlight", {
            settled,
            total: bulkRerun.total,
          })
