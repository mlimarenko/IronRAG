...
export function UploadQueueSection({ controller, t }: Readonly<UploadQueueSectionProps>) {
  const {
    cancelUploadDialog,
    confirmUploadDialog,
    duplicateConflict,
      ...
      >
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-3">
            <div>
              <Label htmlFor="document-upload-dialog-hint">{t('documents.documentHint')}</Label>
              <Input
          ...
          <DialogFooter className="flex-col gap-2 sm:flex-row">
            ...
            <Button onClick={confirmUploadDialog}>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter className="flex-col gap-2 sm:flex-row">
            <Button
              variant="default"
              onClick={async () => {
                await resolveDuplicate('replace')
              }}
            >
