...
const featureNames = ['admin', 'assistant', 'auth', 'dashboard', 'documents', 'graph', 'swagger']
...
const featureBoundaryConfig = (featureName) => {
  const foreignFeaturePattern = featureNames.filter((name) => name !== featureName).join('|')
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            ...
            {
              regex: String.raw`^\.\./(?:\.\./)*(?:${foreignFeaturePattern})(?:/|$)`,
