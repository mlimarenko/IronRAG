...
test('Storybook stories match committed visual baselines', async ({ page, request }) => {
  ...
  expect(stories, 'expected Storybook stories under src/**/*.stories.tsx').not.toHaveLength(0)
