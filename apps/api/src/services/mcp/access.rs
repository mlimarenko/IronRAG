...
pub(crate) use self::{
    catalog::{
        create_library, create_workspace, update_library, update_workspace, visible_catalog,
        visible_libraries, visible_workspaces,
    },
    documents::{
...
pub(crate) use self::{
    catalog::{
        library_catalog_ref, load_library_by_catalog_ref, load_sole_query_authorized_library,
