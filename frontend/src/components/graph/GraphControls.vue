    ...
    <div class="rr-graph-controls__toolbar">
      <div class="rr-graph-controls__primary">
        ...
        >
          ...
          <div
            class="rr-graph-toolbar__count"
            :class="{ 'rr-graph-toolbar__count--compact': showStatusSummary === false }"
          >
            <span
              v-if="showStatusSummary !== false && graphStatus"
              :class="`rr-graph-toolbar__status rr-graph-toolbar__status--${graphStatus}`"
            >
              {{ $t(`graph.statuses.${graphStatus}`) }}
            </span>
            <span
              v-if="showStatusSummary !== false && convergenceStatus"
