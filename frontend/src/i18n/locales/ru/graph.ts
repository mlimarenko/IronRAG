export default {
  ...
  panels: {
    ...
    detail: {
      ...
      technicalHint: 'Меняйте глубину subgraph и проверяйте ограниченную graph-структуру только когда это действительно нужно.',
    ...
    diagnostics: {
      ...
      noProject: {
        title: 'Сначала выберите проект',
        message: 'Диагностика привязана к проекту. Выберите его, чтобы увидеть готовность графа и блокеры.',
      ...
      technicalHint: 'Counts по документам, чанкам, эмбеддингам и provenance остаются доступны здесь как вторичная диагностика.',
    },
  },
  common: {
