...
memory-heavy задач в одном worker process. Дефолтные deployment caps: 16 jobs
глобально, 8 на workspace и 4 на library; эффективное число jobs на процесс всё
равно равно меньшему из queue caps, DB-pool slots worker-а и его локального
memory-derived claim cap.
